<template>
  <div>
    <v-banner single-line>
      ...
      <span class="font-weight-black"> ลงทะเบียนบัตรประจำรถป้อมประสานงาน </span>
...
export default {
  ...
  methods: {
    async SerachCotaid() {
      ...
      if (this.editedItem.cota.length == 5) {
        ...
        this.loadcotabyid(this.editedItem.cota)
          .then(async (_) => {
            console.log("_", _, _.Prefix, _.FName, _.LName, _.NationalId);
    ...
    async SerachCarid() {
      ...
      this.loadcarregister(this.editedItem.carid)
        .then(async (_) => {
          ...
          console.log("edit");
          this.cariddelete = this.carregister[0].carid;
        ...
        .catch(async (error) => {
          ...
          if (this.editedIndex == -1) {
            ...
            await this.loadtruckregistertempcarid(data)
              .then(async (result) => {
                console.log("result", result);
    ...
    async CarRegisterHandlerSubmit() {
      ...
      console.log("this.cariddelete", this.cariddelete);
      const deletedata = {
        carid: this.cariddelete,
      };
      await this.createcarregister(formData)
        .then(async (_) => {
          ...
          await this.deletecarregister(deletedata)
            .then((resultdelete) => {
              this.clearItem();
            })
            .catch((error) => {
          ...
          this.clearcotalist();
          this.clearcarjoin();
          this.clearregistertemp();
          this.clearcarregister();
    ...
    async clearItem() {
      ...
      this.editedItem.perfix = null;
      this.editedItem.taxidcard = null;
      this.editedItem.cartype = null;
      this.editedItem.cota = null;
      this.editedItem.rfid = null;
      this.editedItem.carid = null;
      this.editedItem.tel = null;
      this.editedItem.tel2 = null;
      this.editedItem.typecar = null;
      this.editedItem.truckzone = null;
    ...
    ...mapActions("registertemp", [
      "loadtruckregistertempcarid",
      "clearregistertemp",
    ]),
  },
};
